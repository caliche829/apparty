									...
									<table width="100%" cellpadding="20" cellspacing="0" border="0">
										<tr>
											<td bgcolor="#ffffff" class="contentblock">
												...
												<h4 class="secondary"><strong><singleline label="Title">Hola {{$name}}</singleline></strong></h4>
												<br>
												<multiline label="Description">
													<p>Tienes una encuesta pendiente por responder de la empresa {{$business}}.<br><br>
														Entra aqui: <a href="http://localhost:8000/survey/show{{$token}}">Responder</a><br><br>
														<br><br>
														Cordialmente,<br>
														Encuestas.
													</p>
